...
{
    public partial class AnswerUpdated : ISpecificRecord
    {
        public static Schema _SCHEMA = Avro.Schema.Parse(@"{""type"":""record"",""name"":""AnswerUpdated"",""namespace"":""Magic8Ball.Infra.IntegrationEvents"",""
                fields"":[
